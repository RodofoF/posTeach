...
export default function SettingsUserEditScreen() {
    ...
    const handleDeleteUser = async () => {
        try {
            ...
            if (response.ok) {
                ...
                navigation.replace('SettingsUserScreen', { refresh: true });
            } else {
    ...
    return (
        <View style={styles.screenContainer}>
            ...
            <Button mode="contained" onPress={handleDeleteUser} style={[styles.buttonDelete]}>
                Deletar Usuário
            </Button>
        </View>
    );
