...
export default function PostsEditScreen({ route }) {
    ...
    const handleEditPost = async () => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                alert(data.message + response.status || 'Erro ao atualizar post');
            }
        } catch (error) {
            alert('Erro ao conectar ao servidor');
        }
    ...
    return (
        <View style={styles.screenContainer}>
            ...
            <Button mode="contained" onPress={handleEditPost} style={styles.button}>
                Atualizar Post
            </Button>
            <Button mode="contained" onPress={handleDeletePost} style={[styles.buttonDelete]}>
                Deletar Post
            </Button>
        </View>
    );
